...
namespace ClinicManagementSystem.api.Services
{
    public interface IAuthService
    {
        ...
        Task<Result<RegisterResponse>> RegisterAsync(string firstNameEN, string? firstNameAR, string lastNameEN, string? lastNameAR, string email, string password, CancellationToken cancellationToken = default);
